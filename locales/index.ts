...
export const de = {
  ...
  "risk-search-placeholder": "Kanton suchen (Name oder Kürzel)",
  "risk-sort-risk-desc": "Sortierung: Risiko absteigend",
  "risk-sort-risk-asc": "Sortierung: Risiko aufsteigend",
  "risk-sort-name-asc": "Sortierung: Name A-Z",
  "risk-showing": "Zeige",
  "risk-of": "von",
...
export const fr = {
  ...
  "risk-search-placeholder": "Rechercher un canton (nom ou code)",
  "risk-sort-risk-desc": "Tri : risque décroissant",
  "risk-sort-risk-asc": "Tri : risque croissant",
  "risk-sort-name-asc": "Tri : nom A-Z",
...
export const it = {
  ...
  "risk-search-placeholder": "Cerca cantone (nome o sigla)",
  "risk-sort-risk-desc": "Ordina: rischio decrescente",
  "risk-sort-risk-asc": "Ordina: rischio crescente",
  "risk-sort-name-asc": "Ordina: nome A-Z",
...
export const en = {
  ...
  "risk-search-placeholder": "Search canton (name or code)",
  "risk-sort-risk-desc": "Sort: risk high to low",
  "risk-sort-risk-asc": "Sort: risk low to high",
  "risk-sort-name-asc": "Sort: name A-Z",
