...
export const de = {
  ...
  "dashboard-linked-case-defect-required": "Für verknüpfte Fälle muss der festgestellte Mangel beschrieben werden, bevor das Protokoll abgeschlossen werden kann.",
  "dashboard-linked-case-verification-required": "Der verknüpfte Fall muss zuerst erfolgreich geladen werden, bevor das Protokoll abgeschlossen werden kann.",
...
export const fr = {
  ...
  "dashboard-linked-case-defect-required": "Pour les dossiers liés, décrivez d'abord le défaut constaté avant de finaliser le protocole.",
  "dashboard-linked-case-verification-required": "Le dossier lié doit d'abord être chargé avec succès avant que le protocole puisse être finalisé.",
...
export const it = {
  ...
  "dashboard-linked-case-defect-required": "Per i casi collegati, descrivi prima il difetto rilevato prima di finalizzare il protocollo.",
  "dashboard-linked-case-verification-required": "Il caso collegato deve prima essere caricato con successo prima che il protocollo possa essere finalizzato.",
...
export const en = {
  ...
  "dashboard-linked-case-defect-required": "Linked cases require a recorded defect description before the protocol can be finalized.",
  "dashboard-linked-case-verification-required": "The linked case must load successfully before the protocol can be finalized.",
