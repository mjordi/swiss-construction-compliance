      ...
      <main className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-sm p-8 rounded-2xl bg-white/[0.02] border border-white/[0.05] text-center">
          ...
          <form action="/auth/recovery" method="post">
            <button className="w-full bg-accent hover:bg-accent/90 text-white font-semibold py-2.5 rounded-lg shadow-lg shadow-accent/10 transition-all duration-200">
